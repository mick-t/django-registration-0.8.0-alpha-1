...
def resend_by_username(request, username, backend='registration.backends.default.DefaultBackend', success_url=None, form_class=None,
             disallowed_url='registration_disallowed',
             template_name='registration/activation_email_resent.html',
             extra_context=None):
...
def resend_by_email(request, backend, email, success_url=None, form_class=None,
             disallowed_url='registration_disallowed',
